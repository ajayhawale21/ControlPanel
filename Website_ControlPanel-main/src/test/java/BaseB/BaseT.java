	...
	public static void initilization() throws InterruptedException {
		...
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Brigosha_Guest\\eclipse-workspace\\Brigosha_Website\\Driver\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browserName.equals("FF")) {
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\Brigosha_Guest\\eclipse-workspace\\Brigosha_Website\\Driver\\geckodriver.exe");
